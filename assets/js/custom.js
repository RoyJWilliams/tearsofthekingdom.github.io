...
(function($){
	...
	$(document).ready(function(){
		...
		if (typeof $.fn.countdown !== 'undefined') {
			...
			$(".nextholiday").countdown('2023/02/18 07:31', function(event) {
				$(this).html(event.strftime(
					'<div class="count"><h2><strong>Roy&apos;s Birthday</strong></h2>Thursday 18th February 2023<br><br><h1><b>%-D Days</h1></b><h4>%-Hh : %-Mm : %Ss</h4>' +
					''
				));
			});
